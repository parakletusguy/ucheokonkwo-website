      ...
      <div className="max-w-[90rem] mx-auto w-full px-6 lg:px-12 relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 lg:pr-10 relative z-20">
          <p className="text-[var(--midnight-green)] font-bold tracking-[0.3em] uppercase text-[10px] mb-8 flex items-center gap-4">
            ...
            {t({ en: 'Idemili North & South', pcm: 'Idemili North & South Na Here', ig: 'Idemili Ugwu na Ndida', ha: 'Idemili Arewa da Kudu', yo: 'Idemili Ariwa ati Guusu' })}
          </p>
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="#" className="flex items-center gap-3 font-medium text-[var(--obsidian)] uppercase tracking-widest text-xs hover:text-[var(--midnight-green)] transition-colors group">
        ...
        <div className="lg:col-span-5 relative mt-16 lg:mt-0">
          <div className="relative w-full aspect-[4/5] lg:aspect-[3/4]">
            ...
            */}
            ...
            />
            <div className="absolute -bottom-8 -left-8 w-64 h-64 border-t border-l border-[var(--midnight-green)]/30 z-20 pointer-events-none"></div>
      ...
      <div className="absolute bottom-0 left-0 w-full bg-[var(--midnight-green)] py-3 z-30 flex items-center border-t border-white/10">
        ...
        <div className="ticker-wrap ml-32 py-1">
          <div className="ticker font-medium text-xs tracking-widest uppercase text-white/80">
            <span className="mx-8 text-[var(--sunlight-yellow)] opacity-50">•</span> {t({ en: 'Nnobi-Alor Road Rehab Commences Phase 2', pcm: 'Nnobi-Alor Road Work Don Start Phase 2', ig: 'Arụmọrụ Ụzọ Nnobi-Alor Ebidiwo Nke Abụọ' })} 
            <span className="mx-8 text-[var(--sunlight-yellow)] opacity-50">•</span> {t({ en: 'Obosi General Hospital Equipment Delivery Complete', pcm: 'Obosi Hospital Equipments Don Arrive Complete', ig: 'Ngwongwo Ụlọ Ọgwụ Obosi Eruola N\'uju' })} 
            <span className="mx-8 text-[var(--sunlight-yellow)] opacity-50">•</span> {t({ en: 'Next Town Hall: Ideani Civic Center, Oct 15', pcm: 'Next Meeting: Ideani Civic Center, Oct 15', ig: 'Nzukọ Ọzọ: Ideani Civic Center, Ọktọba 15' })} 
            <span className="mx-8 text-[var(--sunlight-yellow)] opacity-50">•</span> {t({ en: 'Youth Tech Empowerment Drive Registration Opens', pcm: 'Youth Tech Registration Don Open', ig: 'Ndebanye Aha Nkwado Ndị Ntorobịa Ebidola' })} 
          </div>
        </div>
      </div>
    </section>
