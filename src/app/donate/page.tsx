      ...
      <main className="pt-32 pb-24 relative z-10">
        <div className="max-w-4xl mx-auto px-6 mb-16 text-center">
          ...
          <p className="text-lg text-gray-500 font-light max-w-2xl mx-auto">
            Your generous contributions go a long way in supporting our
            community projects and driving impact where it matters most.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-[var(--midnight-green)] p-10 rounded-3xl text-white shadow-xl relative overflow-hidden group">
              ...
              <h2 className="text-2xl font-bold font-serif mb-6 flex items-center gap-3 relative z-10">
                <span className="material-symbols-outlined text-[var(--sunlight-yellow)]">
                  account_balance
                </span>
                Bank Details
              </h2>
              ...
              <p className="text-white/70 font-light leading-relaxed mb-8 relative z-10 text-sm">
                Please make your donation via a direct bank transfer to the
                account below, then upload the payment receipt on the form.
              </p>
              ...
              <div className="space-y-6 relative z-10">
                <div>
                  ...
                  <p className="text-lg font-medium text-white">Access Bank</p>
                </div>
                <div>
                  <p className="text-[10px] text-white/50 uppercase tracking-widest font-bold mb-1">
                    Account Name
                ...
                <div className="bg-white/10 p-5 rounded-2xl flex justify-between items-center border border-white/10 hover:border-white/30 transition-all">
                  <div>
                    <p className="text-[10px] text-[var(--sunlight-yellow)] uppercase tracking-widest font-bold mb-1">
                      Account Number
                    </p>
                  ...
                  <button
                    onClick={() => navigator.clipboard.writeText("0066712737")}
          ...
          <section className="bg-white p-10 lg:p-12 rounded-3xl border border-gray-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
            {isSuccess ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-10 space-y-6 animate-fade-in">
                ...
                <h3 className="text-3xl font-bold font-serif text-[var(--obsidian)]">
                  Thank You!
                </h3>
                <p className="text-gray-500 max-w-sm">
                  We have received your donation details successfully. We truly
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-2">
                      Payment Receipt or Photo (Optional)
                    </label>
                    ...
                    {!imagePreview ? (
                      ...
                      >
                        <span className="material-symbols-outlined text-4xl text-gray-300 group-hover:text-[var(--midnight-green)] mb-3">
                          cloud_upload
                        </span>
