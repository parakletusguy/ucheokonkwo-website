...
export const metadata: Metadata = {
  ...
  description:
    "Official website of Hon. Uchenna Harris Okonkwo, Federal House of Representatives member (ADC) for Idemili North & South. Scholar (University of Toronto), Entrepreneur (Topwide Ventures), and Progressive Legislator in the 10th National Assembly.",
  keywords: [
    'Uchenna Harris Okonkwo', 'Idemili North and South Federal Constituency', 'Hon. Uchenna Okonkwo Biography',
    'University of Toronto Political Science', 'Topwide Ventures Group', 'Senator Annie Okonkwo Son',
    'ADC Nigeria Candidate', '10th National Assembly Rep Idemili', 'Idemili Legislative Agenda',
    'Anambra State Politics', 'Get Empowered Foundation', 'Uche Okonkwo Scholar',
  ],
