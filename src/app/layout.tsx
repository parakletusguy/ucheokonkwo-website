...
export const metadata: Metadata = {
  ...
  description:
    "Official website of Hon. Uchenna Harris Okonkwo — Constituency-First digital platform for Idemili North & South, serving in Igbo, Yoruba, Hausa, Pidgin and English.",
};
